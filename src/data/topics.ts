...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    exercises: 20,
    published: true,
    Page: lazy(() => import('../topics/ia-en-desarrollo')),
  },
  {
    slug: 'apis-de-ia',
    session: 21,
    ...
    exercises: 20,
    published: true,
    Page: lazy(() => import('../topics/apis-de-ia')),
  },
  {
    ...
    exercises: 20,
    published: true,
    Page: lazy(() => import('../topics/proyecto-inicio')),
  },
  {
    ...
    exercises: 20,
    published: true,
    Page: lazy(() => import('../topics/proyecto-backend')),
  },
  {
    ...
    exercises: 20,
    published: true,
    Page: lazy(() => import('../topics/proyecto-cierre-deploy')),
  },
  {
    ...
    exercises: 20,
    published: true,
    Page: lazy(() => import('../topics/defensa-de-proyectos')),
  },
];
